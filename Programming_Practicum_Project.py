...
def save():
    ...
    f1=open('C:\\Users\\user\\Desktop\\Record\\records\\'+str(ref_var.get())+'.txt','w')
    f1.write(data)
    f1.close()
...
def print():
    data=textarea.get(1.0,END)
    f='C:\\Users\\user\\Desktop\\Record\\records\\'+str(ref_var.get())+'.txt'
...
lbl_ref=Label(F1,text='Employee Id',font=('times new rommon',20,'bold'),fg='black',bg=bg_color)
...
combo_des['value']=('Hr','Accountant','IT','Sales','Finance','Other')
